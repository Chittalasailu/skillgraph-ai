# Relationship queries (one block per Cypher statement)

This file contains the Cypher statements from relationships.cypher wrapped in separate fenced code blocks so they can be executed individually in CognoDB or other Cypher UIs.
